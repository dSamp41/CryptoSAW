        ...
        <div className="main container">
            ...
            <div className="login">
                <form className='loginForm'>
					...
					<div className="social-container">
                        <a className="social" onClick={githubAuth}><GithubIcon/></a>
                        <a className="social" onClick={googleAuth}><i className="fab fa-google"></i></a>
                    </div>
                    ...
                    <button className='ghost mobileLoginBtn' onClick={login} type='button'>Accedi</button>
                </form>
            </div>
			...
			<div className="SU">
				<form>
					...
					<input id='pwRegBox' className='inputBox' type="password" name="pswd" placeholder="Password" onChange={changePw}></input>
        ...
        <div className={containerClass} id="container">
            ...
            <div className="form-container sign-up-container">
                <form action="#">
                    <h1>Crea Account</h1>
                    <div className="social-container">
                        <a href="#" className="social" onClick={githubAuth}><GithubIcon/></a>
                        <a href="#" className="social" onClick={googleAuth}><i className="fab fa-google"></i></a>
                    </div>
                    <span>o usa l'email per registrarti</span>
                    <input id='usernameRegBox' className='inputBox' type="username" placeholder="Username" onChange={changeUsername} />
                    <input id='emailRegBox' className='inputBox' type="email" placeholder="Email" onChange={changeEmail} />
                    <input id='pwRegBox' className='inputBox' type="password" placeholder="Password" onChange={changePw} />
...
export default function LoginForm(){
    ...
    const register = () => {
        ...
        if(!username) usernameRegBox!.setAttribute('class', 'inputBox error');
        if(!email) emailRegBox!.setAttribute('class', 'inputBox error');
        if(!password) pwRegBox!.setAttribute('class', 'inputBox error'); 
